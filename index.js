...
async function fromQrResult(chatId, result, msg) {
    ...
    if(queryResult.added){
        bot.sendMessage(chatId, `${queryResult.addedValue >= 0 ? `${queryResult.addedValue} успешно добавленно на ваш баланс` : `${queryResult.addedValue * -1} успешно снято с вашего баланса` }`);
    } else{
